...
import tsai_gpt.packed_dataset as packed_dataset
from tsai_gpt import Config, Tokenizer
import os 
# [
#     # "arxiv_sample.jsonl",
#     # "book_sample.jsonl",
#     # "c4_sample.jsonl"
#     "generated_data_0000000000.json", 
#     "generated_data_0000000001.json"  
...
def prepare_sample(
    ...
    filenames_sample = os.listdir('data/data_gneration')

    tokenizer = Tokenizer(checkpoint_dir)
    print(f'prepare sample inside: filenames_sample : {filenames_sample}')
...
#prepare(sample=True,source_path=Path('capstone_part1/data/RedPajama-Data-1T-Sample'),checkpoint_dir=Path('checkpoints/microsoft/phi-2'),destination_path=Path('capstone_part1/data/redpajama_sample'))
